...
drop policy if exists portal_documents_storage_select_own on storage.objects;
create policy portal_documents_storage_select_own
...
create policy portal_documents_storage_insert_own
...
create policy portal_documents_storage_delete_own
