...
export function CalendlyEmbed() {
  ...
  const appointmentUrl = import.meta.env.VITE_CALENDLY_URL as string | undefined;

  // The current contact page uses the first-party appointment picker. Keep this
  // optional embed safe for deployments that explicitly configure Calendly.
